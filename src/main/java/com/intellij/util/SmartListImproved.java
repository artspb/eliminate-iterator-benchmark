 ...
 */
public class SmartListImproved<E> extends AbstractList<E> implements RandomAccess {
  private int mySize;
  private Object myElem; // null if mySize==0, (E)elem if mySize==1, Object[] if mySize>=2

  public SmartListImproved() { }

  public SmartListImproved(E element) {
    add(element);
  }

  public SmartListImproved(@NotNull Collection<? extends E> elements) {
  ...
  @SafeVarargs
  public SmartListImproved(@NotNull E... elements) {
  ...
  private class Itr implements Iterator<E> {
    ...
    public E next() {
      ...
      Object[] elementData = (Object[]) SmartListImproved.this.myElem;
    ...
    public void remove() {
      ...
      try {
        SmartListImproved.this.remove(lastRet);
        cursor = lastRet;
        lastRet = -1;
    ...
    public void forEachRemaining(Consumer<? super E> consumer) {
      ...
      final Object[] elementData = (Object[]) SmartListImproved.this.myElem;
      if (i >= elementData.length) {
        throw new ConcurrentModificationException();
      }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SmartListImproved) {
      return equalsWithSmartList((SmartListImproved)o);
    }
  ...
  private boolean equalsWithSmartList(SmartListImproved that) {
